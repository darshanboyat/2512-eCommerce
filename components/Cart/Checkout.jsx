...
const Checkout = ({ currency, items }) => {
  ...
  useEffect(() => {
    ...
    getConvertedCurrency(totalPrice, currency).then((res) =>
      setTotalPrice(res)
    );
    ...
    getConvertedCurrency(discountedPrice, currency).then((res) =>
      setDiscountedPrice(res)
    );
  }, [items]);
